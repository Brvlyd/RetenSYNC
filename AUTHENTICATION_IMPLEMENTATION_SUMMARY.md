...
```typescript
// Permission checking
import { hasPermission, canAccessRole, PERMISSIONS } from '@/lib/security-utils';
...
```tsx
import { useEnhancedAuth, RoleSwitchComponent, QuickLoginComponent } from '@/examples/role-switching-example';
...
```tsx
import { SecurityStatusComponent, useComponentSecurity } from '@/components/security/SecureComponents';
...
import { PermissionGuard, RoleGuard } from '@/components/security/SecureComponents';
```
