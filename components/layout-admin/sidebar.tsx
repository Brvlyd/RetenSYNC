...
const getIconColor = (gradientColor: string) => {
  if (gradientColor.includes('amber'))
    return 'text-amber-600 dark:text-amber-400 group-hover:text-blue-600 dark:group-hover:text-blue-400';
  if (gradientColor.includes('teal'))
    return 'text-teal-600 dark:text-teal-400 group-hover:text-blue-600 dark:group-hover:text-blue-400';
  if (gradientColor.includes('violet'))
    return 'text-violet-600 dark:text-violet-400 group-hover:text-blue-600 dark:group-hover:text-blue-400';
  if (gradientColor.includes('emerald'))
    return 'text-emerald-600 dark:text-emerald-400 group-hover:text-blue-600 dark:group-hover:text-blue-400';
  if (gradientColor.includes('indigo'))
    return 'text-indigo-600 dark:text-indigo-400 group-hover:text-blue-600 dark:group-hover:text-blue-400';
  if (gradientColor.includes('slate'))
    return 'text-slate-600 dark:text-slate-400 group-hover:text-blue-600 dark:group-hover:text-blue-400';
  if (gradientColor.includes('green'))
    return 'text-green-600 dark:text-green-400 group-hover:text-blue-600 dark:group-hover:text-blue-400';
  if (gradientColor.includes('rose'))
    return 'text-rose-600 dark:text-rose-400 group-hover:text-blue-600 dark:group-hover:text-blue-400';
  if (gradientColor.includes('yellow'))
    return 'text-yellow-600 dark:text-yellow-400 group-hover:text-blue-600 dark:group-hover:text-blue-400';
  if (gradientColor.includes('cyan'))
    return 'text-cyan-600 dark:text-cyan-400 group-hover:text-blue-600 dark:group-hover:text-blue-400';
  if (gradientColor.includes('purple'))
    return 'text-purple-600 dark:text-purple-400 group-hover:text-blue-600 dark:group-hover:text-blue-400';
  if (gradientColor.includes('pink'))
    return 'text-pink-600 dark:text-pink-400 group-hover:text-blue-600 dark:group-hover:text-blue-400';
  // Default fallback
