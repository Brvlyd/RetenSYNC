...
export const feedbackData = [
  {
    ...
    content:
      'Great collaboration on the user interface design. Your attention to detail really made a difference.',
    date: '2024-01-15',
    status: 'received',
  },
  {
    ...
    content:
      'Excellent job mentoring new team members. Your leadership skills have grown significantly.',
    date: '2024-01-12',
    status: 'received',
  },
  {
    ...
    content:
      'I implemented automated testing which reduced deployment time by 40%.',
    date: '2024-01-10',
    status: 'sent',
  },
];
...
export const goalsData: Goal[] = [
  {
    ...
    description:
      'Enhance cross-functional team communication and collaboration through better tools and processes.',
    progress: 85,
    dueDate: '2024-12-31',
    status: 'in-progress',
    priority: 'high',
    ...
    keyResults: [
      ...
      {
        description: 'Establish weekly cross-team sync meetings',
        completed: false,
      },
    ],
  },
  {
    ...
    description:
      'Improve customer satisfaction scores through enhanced service delivery and support processes.',
    progress: 70,
    dueDate: '2024-11-30',
    status: 'in-progress',
    priority: 'high',
  ...
  },
  {
    ...
    description:
      'Lead the company\'s digital transformation by modernizing key systems and processes.',
    progress: 45,
    dueDate: '2025-03-31',
    status: 'in-progress',
    priority: 'medium',
  ...
  },
  {
    ...
    description:
      'Create a comprehensive talent development program to enhance employee skills and career growth.',
    progress: 100,
    dueDate: '2024-10-31',
    status: 'completed',
    priority: 'medium',
    ...
    keyResults: [
      ...
      {
        description: 'Establish career progression framework',
        completed: true,
      },
    ],
  },
  {
    ...
    description:
      'Develop and execute strategies to increase revenue by 25% through new market opportunities.',
    progress: 60,
    dueDate: '2024-12-31',
    status: 'in-progress',
    priority: 'high',
    ...
    keyResults: [
      ...
      {
        description: 'Establish partnerships with key distributors',
        completed: true,
      },
    ],
  },
...
export const shoutoutsData = [
  {
    ...
    to: 'Tasya Salsabila',
    message:
      'Amazing work on the client presentation! Your research was thorough and the delivery was flawless.',
  ...
  },
  {
    ...
    to: 'Engineering Team',
    message:
      'Thank you for the quick turnaround on the bug fixes. Your dedication kept our customers happy!',
  ...
  },
  {
    ...
    message:
      'The new design system is incredible! It will make our development process so much more efficient.',
...
export const learningData = [
  {
    ...
    duration: '5 min',
    content:
      'Learn key strategies for leading distributed teams effectively in the modern workplace...',
    completed: false,
    helpful: 0,
  },
  {
    ...
    duration: '8 min',
    content:
      'How to use analytics and data insights to improve business outcomes and make informed decisions...',
    completed: true,
    helpful: 5,
  },
  {
    ...
    duration: '7 min',
    content:
      'Master the art of clear, concise, and impactful communication in professional settings...',
    completed: false,
    helpful: 0,
  },
  {
    ...
    duration: '15 min',
    content:
      'Essential project management principles and methodologies for successful project delivery...',
    completed: true,
    helpful: 8,
  },
];
