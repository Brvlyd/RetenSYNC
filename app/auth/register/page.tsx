...
export default function RegisterPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.phone_number) {
      ...
      if (
        !indonesianPhoneRegex.test(cleanPhone) ||
        digitCount < 10 ||
        digitCount > 15
      ) {
        newErrors.phone_number =
          'Phone number must start with +62 or 08 and contain 10-15 digits';
      }
    }
    ...
    if (!formData.department || formData.department === '') {
      ...
      isNaN(Number(formData.department)) ||
      Number(formData.department) <= 0
    ) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#f7f7fa] via-[#fff7e6] to-[#f0f4e8] dark:from-[#23232a] dark:via-[#23281a] dark:to-[#23281a] flex items-center justify-center p-3 sm:p-4 overflow-auto">
        ...
        >
          ...
          <h2 className="text-xl sm:text-2xl font-bold text-[#d96f27] dark:text-[#94c47d] mb-2">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f7f7fa] via-[#fff7e6] to-[#f0f4e8] dark:from-[#23232a] dark:via-[#23281a] dark:to-[#23281a] flex flex-col items-center justify-start p-3 sm:p-4 relative pt-6 sm:pt-8 pb-12 sm:pb-16">
      ...
      <div
        className="w-full max-w-full relative z-10 flex justify-center items-start mb-12 sm:mb-16"
        style={{ height: '100%' }}
      >
        <motion.div
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          ...
          >
            ...
            <p className="text-[#d96f27] dark:text-[#94c47d] bg-[#fff7e6]/70 dark:bg-[#23281a]/70 px-2 py-1 rounded-lg inline-block shadow-sm animate-fade-in text-sm sm:text-base font-semibold mb-3 mt-3 text-center">
              Create your account
            </p>
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                <div className="bg-gradient-to-br from-gray-50/80 to-gray-100/50 dark:from-gray-800/40 dark:to-gray-700/30 rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-gray-200/60 dark:border-gray-600/50 shadow-lg backdrop-blur-sm">
                  <h3 className="text-sm font-bold text-[#d96f27] dark:text-[#94c47d] mb-3 sm:mb-4 flex items-center">
                    <span className="w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-[#d96f27] to-[#b95a1f] dark:from-[#94c47d] dark:to-[#7ea864] rounded-full text-white dark:text-[#23232a] flex items-center justify-center text-xs mr-2 sm:mr-3 shadow-lg">
                      1
                    </span>
        ...
        {/* End of motion.div for card animation */}
      </div>
    </div>
  );
}
