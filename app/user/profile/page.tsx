...
export default function ProfilePage() {
  ...
  const getAchievementColor = (type: string) => {
    switch (type) {
      ...
      case 'skill': return 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300';
      case 'leadership': return 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300';
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between">
            <div className="flex items-center space-x-6">
              ...
              <div>
                ...
                <p className="text-blue-100 text-lg mb-1">{profileData.position}</p>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="font-semibold text-gray-900 dark:text-white">4.2/5</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600 dark:text-gray-400">Time at Company</span>
                  <span className="font-semibold text-gray-900 dark:text-white">2.8 years</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-600 dark:text-gray-400">Department Rank</span>
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">EMP-2024-001</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">Full-time, Remote</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  <User className="w-4 h-4 text-gray-400" />
                  <div>
                    <p className="text-sm font-medium text-gray-900 dark:text-white">Reports To</p>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">Receive updates about your progress</p>
                  </div>
                </div>
