        ...
        <div className="mb-8">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-gray-600">Complete surveys and provide feedback</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
          <div className="max-w-md mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              We're developing a comprehensive survey system that will allow you to 
              participate in company-wide surveys, pulse checks, and feedback forms.
            </p>
            
            <div className="bg-gray-50 rounded-lg p-4">
              <p className="text-sm text-gray-500">
                For now, you can use the Self Assessment feature to provide feedback 
                about your performance and development needs.
              </p>
            </div>
